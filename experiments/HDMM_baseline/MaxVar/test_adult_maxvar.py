...
from calculate_variance import calculate_variance, calculate_variance_sampling,calculate_variance_marginal,expected_error
...
def default_params():
    ...
    params['workload'] = 1
    params['output'] = 'hderror_2023_05_02.csv'
...
if __name__ == '__main__':
    ...
    output=expected_error(W.matrices[0].base,A)
