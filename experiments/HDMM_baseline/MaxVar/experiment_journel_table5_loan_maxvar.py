...
from benchmarks_marginal import DimKKrons_kway_small,DimKKrons_small,DimKKrons
...
def loan_kway_prefix_multi_way(k):
    P = workload.Prefix
    I = workload.Identity
    w=DimKKrons_kway_small([P(101),P(101),P(101),P(101),I(3),I(8),I(36),I(6),I(51),I(4),I(5),I(15)], k)
    #w2=workload.DimKMarginals((100, 100, 100, 99, 85, 42, 16, 15, 9, 7, 6, 5, 2, 2), [0,1,2,3])
    return w

def loan_kway_prefix(k):
    P = workload.Prefix
    I = workload.Identity
    w=DimKKrons_small([P(101),P(101),P(101),P(101),I(3),I(8),I(36),I(6),I(51),I(4),I(5),I(15)], k)
    #w2=workload.DimKMarginals((100, 100, 100, 99, 85, 42, 16, 15, 9, 7, 6, 5, 2, 2), [0,1,2,3])
    return w

def loan_kway_prefix_sanity(k):
    P = workload.Prefix
    I = workload.Identity
    w=DimKKrons([P(101),P(101),P(101),P(101),I(3),I(8),I(36),I(6),I(51),I(4),I(5),I(15)], k)
    #w2=workload.DimKMarginals((100, 100, 100, 99, 85, 42, 16, 15, 9, 7, 6, 5, 2, 2), [0,1,2,3])
    return w
...
def run_table5(attribute_Data):

    for i in range(1,5):
        if i ==4:
            W=loan_kway_prefix_multi_way(3)
        else: 
            W=loan_kway_prefix(i)
        ...
        v = np.array(v)
        with open('table5_loan.npy', 'wb') as f:
            np.save(f,v)
