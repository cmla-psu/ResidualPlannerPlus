...
def cps_big():
    ...
    print(line)
    W0 = DimKKrons([P(50), P(100),I(7), I(4), I(2)], 0)
    W1 = DimKKrons([P(50), P(100),I(7), I(4), I(2)], 1)
    W2 = DimKKrons([P(50), P(100),I(7), I(4), I(2)], 2)
    W3 = DimKKrons([P(50), P(100),I(7), I(4), I(2)], 3)
    #Adding all concat together 
    W_all_dim=W0+W1+W2+W3
    W_all=workload.VStack(W_all_dim)
    
    print('CPS W_add Shape is' + str(W_all.shape))
