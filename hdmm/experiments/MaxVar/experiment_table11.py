...
def run_table2(attribute_Data,dims=[0,1,2,3]):
    written_dict={}
    for n in [2,4,8,16,32,64,128,256,512,1024]:
        ...
        v = np.array(v)
        attribute_Data.add_data(n, t1 - t0, v.max())
...
if __name__ == '__main__':
    ...
    with open(fileName, 'w') as f:
        f.write('n,avgtimes,vartimes,avgMaxVar,varMaxVar\n')
    output_dict={}
    for i in range(5):
        run_table2(attribute_Data,dims=[0,1,2,3])
        
    print("-----------------------------------------")
    print("n,avgtimes,vartimes,avgMaxVar,varMaxVar")
    for n in [2,4,8,16,32,64,128,256,512,1024]:
